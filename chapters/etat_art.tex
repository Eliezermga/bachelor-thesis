...
%------------------------------------------------------------
\subsection{Traduction automatique neuronale (\ac{TAN})}
%------------------------------------------------------------
...
\begin{figure}[H]
    ...
    \caption{L’Encodeur-Décodeur \cite{keldenich2021encoder}}
...
\begin{figure}[H]
    ...
    \caption{Architecture Transformer \cite{vaswani2017attention}}
...
\begin{figure}[H]
    ...
    \caption{ Répartition des langues selon leur nombre de locuteurs et leurs ressources en NLP \cite{laumann2022challenges}}
    \label{fig:  Répartition des langues selon leur nombre de locuteurs et leurs ressources en NLP}
\end{figure}

%------------------------------------------------------------
\subsection{Défis du \ac{TAL} pour les langues africaines}
%------------------------------------------------------------
