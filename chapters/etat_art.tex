...
Ce mémoire se positionne à la pointe de la recherche actuelle en utilisant le \textit{fine-tuning} de modèles étatiques (NLLB-200, mBART-50) pour compenser la rareté des données, selon une démarche validée pour d'autres langues à faibles ressources telles que le môn \cite{thu2023monenglishtranslation}.
