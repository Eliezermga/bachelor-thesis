...
Cette revue de littérature a été réalisée selon une démarche systématique inspirée des recommandations \ac{PRISMA}. Les recherches bibliographiques ont été effectuées dans 4 bases de données scientifiques, notamment Scopus, \ac{ACM}, \ac{IEEE} et Google Scholar.
...
La requête de recherche de base, élaborée à partir de ces mots-clés, est présentée ci-dessous. Celle-ci a ensuite été adaptée aux spécificités des différentes bases de données consultées :
