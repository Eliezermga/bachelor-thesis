...
L'analyse de la littérature met en évidence le manque de ressources numériques pour les langues à faibles ressources, ainsi que l'intérêt des corpus parallèles et des modèles multilingues pré-entraînés pour améliorer la traduction automatique. Ces constats justifient la présente recherche sur le ruund, langue encore peu documentée dans les technologies du langage \cite{ranathunga2023neural, haulai2023construction, rakhimov2024enhancing}.
